<?php
/**
 * Template Name: آگهی مفقودی موتور
 *
 * @package WordPress
...
//    connection
    if($connection){
        ...
        if($row['u_id'] == $f_uid){
         ...
         VALUES ('$f_noe', '$f_uid', '$f_query','$f_name', '$f_fname', '$f_melli', '$f_shsh', '$f_pedar', '$f_phone', '$f_ostan', '$f_shahr', '$f_address', '$f_zipcode', '$f_girandeh', '$f_date', '$f_mafghoodi', '$f_pm_mores', '$f_giran')";
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-m-header">
                    <h1>
                        ثبت آگهی مفقودی مدارک موتور سیکلت

                    </h1>
                    <h2>
                        سفارش آنلاین چاپ آگهی سند کمپانی، کارت و برگ سبز موتورسیکلت و... در روزنامه سراسری کثیرالانتشار با ارسال رایگان
                    </h2>
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <form method="post" enctype="multipart/form-data" action="" onsubmit="submitForm()">
                                <ul class="infos">
                                    ...
                                    <li class="mt-4" >
                                        <label class="form-item-title" style="font-size: 15px;font-weight: 900;" for="">
                                            مفقودی ها را انتخاب کنید :
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-m-item-box-ch">
                                                        <input type="checkbox" name="it_motor[]" id="it_55" value="پلاک موتور">
                                                        <label class="form-item-title" for="it_55">پلاک موتور</label>
                                                    </div>
                                                    <div class="form-m-item-box-ch">
                                                    ...
                                                    <div class="form-m-item-box-ch">
                                                        <input type="checkbox" name="it_motor[]" id="it_11" value="کارت موتور">
                                                        <label class="form-item-title" for="it_11">کارت موتور</label>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-m-item-box-ch">
                                                        <input type="checkbox" name="it_motor[]" id="it_10" value="سند کمپانی">
                                        ...
                                        <div class="row p_styles">
                                            ...
                                            <div class="col-12 col-md-4 d-none">
                                                <div class="form-m-item-box">
                                                    ...
                                                    <input type="text" name="ip_3_3" id="ip_3_3" placeholder="مثال : مشکی / سفید و...">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-m-item-box">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-m-item-box">
                                                    ...
                                                    <input type="text" name="ip_5_5" id="ip_5_5" placeholder="مثال: xxx - xxxxx" required>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-m-item-box">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-m-item-box">
                                                    ...
                                                    <input type="text" name="ip_9_9" id="ip_9_9" >
                                                </div>
                                            </div>
...
<!--                                                <li>رنگ خودرو : <b>--><?php //echo $_POST['ip_3_3']; ?><!--</b></li>-->
                                                ...
                                                <?php if(!empty($_POST['ip_6_6'])){?><li>شماره تنه : <b><?php echo $_POST['ip_6_6']; ?></b></li><?php } ?>
                                ...
                                <div class="texts">
                                    ...
                                    <ul>
                                        ...
                                        <li>تحویل گیرنده : <b><?php echo $_POST['ip_11'] . " - (" . $_POST['ip_12'] . ")"; ?></b></li>
                                    </ul>
                                    <!--                                    <p>
...
<script>
    ...
    if(fac === 0){
        ...
        document.getElementById('ip_12').required = true;
    }
    function porc(){
        ...
        if(fac === 0){
            ...
            document.getElementById('ip_12').required = false;
            ...
            document.getElementById('ip_12').value = "";
        }
