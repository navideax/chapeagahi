<?php
/**
 * Template Name: آگهی مفقودی مدارک هویتی
 *
 * @package WordPress
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-m-header">
                    <h1>
                        ثبت آگهی مفقودی مدارک هویتی

                    </h1>
                    <h2>ثبت آنلاین آگهی مفقودی مدارک هویتی در روزنامه کثیرالانتشار سراسری با ارسال رایگان</h2>
                                    ...
                                    <li style="background: #eeeeee;padding: 15px;border-radius: 5px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-m-item-box-ch">
                                                    <input type="checkbox" name="it_personal[]" id="moress" value="کارت پایان خدمت">
                                                    <label class="form-item-title" for="moress">کارت پایان خدمت</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-m-item-box-ch">
