<?php
/**
 * Template Name: ُایر مدارک مفقودی
 *
 * @package WordPress
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-m-header">
                    <h1>
                        ثبت آگهی سایر مدارک مفقودی شما


                    </h1>
                    <h2>ثبت آنلاین آگهی در روزنامه کثیرالانتشار سراسری</h2>
                                ...
                                <ul class="infos">
                                    ...
                                    <li class="mt-4">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-m-item-box">
                                                    <textarea name="massmoz" id="moreadv" cols="30" rows="10" style="display: block" placeholder="متن خود را وارد کنید" required></textarea>
                                                </div>
                                            </div>
