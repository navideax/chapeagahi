<?php
/**
 * Template Name: آگهی مفقودی تحصیلی
 *
 * @package WordPress
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-m-header">
                    <h1>
                        ثبت آگهی مفقودی مدارک تحصیلی


                    </h1>
                    <h2>ثبت آنلاین آگهی مفقودی مدارک تحصیلی در روزنامه کثیرالانتشار با ارسال رایگان</h2>
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <form method="post" enctype="multipart/form-data" action="" onsubmit="submitForm()">
                                <ul class="infos">
                                    ...
                                    <li style="background: #eeeeee;padding: 15px;border-radius: 5px;">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-m-item-box-ch">
                                                    <input type="checkbox" name="it_tahsili[]"  id="more122"  value="کارت دانشجویی">
                                                    <label class="form-item-title" for="more122">کارت دانشجویی</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-m-item-box-ch">
                                                    <input type="checkbox" name="it_tahsili[]"  id="more1422"  value="مدرک موقت">
                                                    <label class="form-item-title" for="more1422">مدرک موقت</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-m-item-box-ch">
                                                    <input type="checkbox" name="it_tahsili[]"  id="more1423"  value="دانشنامه">
                                                    <label class="form-item-title" for="more1423">دانشنامه</label>
                                                </div>
                                            </div>
                                                <div class="col">
                                                    <div class="form-m-item-box-ch">
                                                ...
                                                <div class="col-12">
                                                    <div class="p_styles">
                                                        ...
                                                        <p class="p_style">
                                                            مدرک تحصیلی / کارت دانشجویی اینجانب ............ فرزند ..........به شماره ملی...... در مقطع ....... رشته ....... صادره از واحد دانشگاهی ...... به شماره ........ و تاریخ ....... مفقود گردیده است. از یابنده تقاضا می گردد اصل مدرک / کارت دانشجویی را به دانشگاه ......... به نشانی ........... تحویل دهد.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-12">
