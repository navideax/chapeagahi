                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <form method="post" enctype="multipart/form-data" action="" onsubmit="submitForm()">
                                <ul class="infos">
                                    ...
                                    <li class="mt-5">
                                        <label class="form-item-title" style="font-size: 18px;" >اطلاعات سفارش دهنده آگهی :</label>

                                    </li>
                                    <li class="mt-3" id="personals">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-4"  style="display: none">
                                                <div class="form-m-item-box">
                                                    ...
                                                    <input type="text" name="ip_3" id="ip_3" placeholder="برای اتباع خارجی نیاز نیست"  value="<?php if(!empty($_POST['ip_3'])){echo $_POST['ip_3'];} ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4" style="display: none">
                                                <div class="form-m-item-box">
                                                    <label class="form-item-title" for="ip_4"> شماره شناسنامه </label>
                                                    <input type="text" name="ip_4" id="ip_4" placeholder="اختیاری"  value="<?php if(!empty($_POST['ip_4'])){echo $_POST['ip_4'];} ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4"  style="display: none">
                                                <div class="form-m-item-box">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-m-item-box">
                                                    ...
                                                    <input type="text" name="ip_10" id="ip_10"  value="<?php if(!empty($_POST['ip_10'])){echo $_POST['ip_10'];} ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-m-item-box">
                                    ...
                                    <div class="row p_styles">
                                        <li class="mb-3">
                                            <label class="form-item-title" style="font-size: 18px;" >اطلاعات صاحب سند :</label>
                                    ...
                                    elseif($_GET['q'] == "motor"){
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="form-m-item-box-ch">
                                                <input type="checkbox" name="it_car[]" id="it_11" value="کارت موتور">
