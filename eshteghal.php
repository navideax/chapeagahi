        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-m-header">
                    <h1>
                        ثبت آگهی مفقودی پروانه اشتغال


                    </h1>
                    <h2>چاپ آگهی مفقودی پروانه اشتغال، نظام مهندسی، نظام پزشکی، نظام کشاورزی و...</h2>
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <form method="post" enctype="multipart/form-data" action="" onsubmit="submitForm()">
                                <ul class="infos">
                                    ...
                                    <li class="mt-4">
                                        <label class="form-item-title" style="font-size: 15px;font-weight: 900;"> مفقودی های خود را شرح دهید : <b class="foooor-force">*</b>
                                            <span style="font-size: 10px;background: #eeeeee;padding: 5px;border-radius: 50px;font-weight: 300;">
                                            جهت درج در آگهی
                                        </span>
                                        </label>
